-- Create Missing Tables (Without Foreign Keys First)
USE accunite_attendance;

-- 1. Create attendance_records table (without foreign key first)
...
-- 2. Create attendance_edits table
...
-- 3. Create freelancer_sessions table (check if freelancers has freelancer_id first)
-- First check: DESCRIBE freelancers;
-- If freelancer_id exists, create the table:
